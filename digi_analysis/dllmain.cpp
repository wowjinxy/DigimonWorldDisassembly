...
// original implementation (`dx8_orig.dll`), forwards selected exports
...
BOOL APIENTRY DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpReserved) {
    ...
    case DLL_PROCESS_ATTACH:
        ...
        // dx8_orig.dll is present in the same directory as this DLL.
        g_dx8 = LoadLibraryA("dx8_orig.dll");
        if (g_dx8) {
