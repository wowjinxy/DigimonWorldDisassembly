...
// Korean PC release of Digimon World.  Each function is named
// after its address in the original binary (e.g. `0x401000`).
// The implementations live in functions.cpp.
